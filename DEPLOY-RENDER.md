...
- O Render lê o ficheiro `render.yaml` e cria **a app web + a base de dados** automaticamente.

## 4. Variáveis de ambiente (no painel do serviço web, em *Environment*)
Preenche estas com os **teus** valores (as marcadas `sync:false` no blueprint):
```
...
- Render Web (Starter) ~7 USD + Postgres (Basic) ~7 USD  →  ~13–14 €/mês
