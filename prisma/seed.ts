...
async function main() {
  ...
  const items = [
    { namePt: "Tarte de Frutos Vermelhos", nameEn: "Red Berry Tart", catPt: "frutos vermelhos", catEn: "red berries",
      ...
      basePrice: 3400, leadHours: 48, photos: ["photo-1565958011703-44f9829ba187","photo-1488477181946-6428a0291777"] },
    { namePt: "Entremet de Chocolate Negro", nameEn: "Dark Chocolate Entremet", catPt: "chocolate", catEn: "chocolate",
      ...
      basePrice: 3800, leadHours: 48, photos: ["photo-1578985545062-69928b1d9587"] },
    { namePt: "Pavlova de Época", nameEn: "Seasonal Pavlova", catPt: "da época", catEn: "seasonal",
      ...
      basePrice: 3000, leadHours: 0, photos: ["photo-1551024601-bec78aea704b"] },
    { namePt: "Tarte de Limão Merengada", nameEn: "Lemon Meringue Tart", catPt: "cítrico", catEn: "citrus",
      ...
      basePrice: 3000, leadHours: 24, photos: ["photo-1488477181946-6428a0291777"] },
    { namePt: "Red Velvet", nameEn: "Red Velvet", catPt: "clássico", catEn: "classic",
      ...
      basePrice: 3200, leadHours: 48, trackStock: true, stock: 6, photos: ["photo-1565958011703-44f9829ba187"] },
    { namePt: "Cheesecake de Frutos Vermelhos", nameEn: "Red Berry Cheesecake", catPt: "frutos vermelhos", catEn: "red berries",
      ...
      basePrice: 3100, leadHours: 24, photos: ["photo-1464349095431-e9a21285b5f3"] },
  ];
  ...
  for (const [i, it] of items.entries()) {
    await db.product.create({
      data: {
        ...
        descPt: it.descPt, descEn: it.descEn, basePrice: it.basePrice, leadHours: it.leadHours, sortOrder: i,
